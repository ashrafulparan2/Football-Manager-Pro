...
public class newmysquad extends javax.swing.JFrame {
...
//            jPanel2.repaint();
    ...
    private void initComponents() {
        ...
        country.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Country", "Argentina", "Brazil", "Spain" ,"Germany","France","England","Norway"}));
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        // TODO add your handling code here:
        jPanel2.removeAll();
        String sql ="select * from squad where name like '%"+jTextField1.getText()+"%' or club like '%"+jTextField1.getText()+"%'";
...
//        String sql= "SELECT * FROM signupplayer WHERE club="+"\""+s+"\""; 
           String sql = "select * from squad where club "+s+" and year "+s4+" and position "+s3+" and country "+s2;
           System.out.println(sql);
        try{
            pst = co.prepareStatement(sql);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              //  jTable1 p=new jTable1();
                ...
                new newmysquad().setVisible(true);
            }
        });
    }
